...
const getNextTierInfo = (points) => {
  if (points < DEFAULT_CONFIG.bronze.minPoints)
    return { tier: 'bronze', pointsNeeded: DEFAULT_CONFIG.bronze.minPoints - points }
  if (points < DEFAULT_CONFIG.silver.minPoints)
    return { tier: 'silver', pointsNeeded: DEFAULT_CONFIG.silver.minPoints - points }
  if (points < DEFAULT_CONFIG.gold.minPoints)
    return { tier: 'gold',   pointsNeeded: DEFAULT_CONFIG.gold.minPoints - points }
