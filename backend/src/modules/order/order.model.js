...
const orderItemSchema = new mongoose.Schema(
  {
    ...
    price:         { type: Number, required: true },   // actual price paid (portion price if applicable)
    quantity:      { type: Number, required: true, min: 1 },
    emoji:         { type: String, default: '🍽️' },
    category:      { type: String, default: null },
    notes:         { type: String, default: null },

    // ── Portion fields (null when item has no portions) ──────────────────────
    portionId:     { type: String, default: null },    // 'half' | 'full' | null
    portionLabel:  { type: String, default: null },    // 'Half Plate' | 'Full Plate' | null
  },
  { _id: false }
)
