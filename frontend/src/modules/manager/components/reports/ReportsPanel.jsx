...
const ReportsPanel = () => {
  ...
  const tickStyle = {
    fontSize: 11,
    fill: isDark ? COLORS.dark.muted : COLORS.brew.soft,
  };
  ...
  return (
    <div className="space-y-5">
      ...
      {daily && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          ...
          <DailyStat
            ...
            icon={TrendingUp}
            label="Avg Order"
            color={COLORS.roles.manager.DEFAULT}
            value={daily.avgOrderValue}
            prefix="Rs "
          />
          <DailyStat
            isDark={isDark}
      ...
      {staff?.waiters?.length > 0 &&
        staff.waiters.some((w) => w.revenue > 0) && (
          <SectionCard
            ...
            {staff.waiters.map((w) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  >
                    {w.calls ?? 0} calls · Rs{" "}
                    {(w.revenue ?? 0).toLocaleString()} revenue
                  </p>
                </div>
                <div
